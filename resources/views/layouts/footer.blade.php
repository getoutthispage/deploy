<footer class="footer" id="footer">
    <div class="container">
                ...
                <div class="footer__top-item">
                    ...
                    <ul class="footer-list">
                        <li class="footer-list__item"><a
                                href="{{ route('category.show', 'accessories')  }}">Аксессуары</a></li>
                        <li class="footer-list__item"><a
                                href="{{ route('category.show', 'everything-for-colorists')  }}">Все для колористов</a>
                        </li>
                        <li class="footer-list__item"><a
                                href="{{ route('category.show', 'everything-for-hairdressers')  }}">Все для
                                парикмахеров</a></li>
                        <li class="footer-list__item"><a href="{{ route('category.show', 'hair-care')  }}">Уход за
                                волосами</a></li>
                        <li class="footer-list__item"><a href="{{ route('category.show', 'сonsumables')  }}">Расходные
                                материалы</a></li>
                        <li class="footer-list__item"><a href="{{ route('category.show', 'tweezers')  }}">Маникюрный
                                инструмент</a></li>
                    </ul>
                </div>
                <div class="footer__top-item">
        ...
        <div class="footer__bottom">
           <div class=""> <p style="color:#fff; margin: 0; font-size: 14px;">Сменить язык:</p>
            <select onchange="location = this.value;">
                ...
                <!-- <option style="color:black" value="{{ \Mcamara\LaravelLocalization\Facades\LaravelLocalization::getLocalizedURL('en') }}" {{ App::getLocale() == 'en' ? 'selected' : '' }}>English</option> -->
            </select>
</div>
