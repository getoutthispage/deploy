            ...
            <div class="header-top">
                <div class="header-top-box">
                    ...
                    <ul class="header-top-list">
                        <li class="header-top-list__item"><a href="{{route('delivery')}}">Доставка и оплата</a></li>
                    ...
                    <a class="header-top-inst" href="https://www.instagram.com/indigoshop.kz/?hl=en">Наш инстаграмм</a>
                </div>
            ...
            <div class="header-middle">
                ...
                <nav class="mobile-menu">
                    ...
                    <ul class="mobile-menu-list">
                        <li><a style="color: #ff5252;" href="{{ route('home') }}">Главная</a></li>
                        ...
                        <li><a style="font-size: 20px;" href="{{ url('/shop/everything-for-hairdressers/machines')}}">Машинки</a></li>
                        <li><a style="font-size: 20px;" href="{{ url('/shop/everything-for-hairdressers/Scissors')}}">Ножницы</a></li>
                        <li><a style="font-size: 20px;" href="{{url('/shop/everything-for-hairdressers/curling-irons-straighteners')}}">Плойки</a></li>
                        <li><a style="font-size: 20px;" href="{{url('/shop/everything-for-hairdressers/combs')}}">Расчески</a></li>
                        <li><a style="font-size: 20px;" href="{{ url('/shop/everything-for-hairdressers/hairdryers') }}">Фены</a></li>
                        <li><a style="font-size: 20px;" href="{{ url('/shop/accessories') }}">Аксессуары</a></li>
                        <li><a style="font-size: 20px;" href="{{url('/shop/everything-for-colorists/Tablets-thermal-paper-scales')}}">Планшеты</a></li>
                        <li><a style="font-size: 20px;" href="{{url('/shop/everything-for-colorists/cups')}}">Чашки</a></li>
                        <li><a style="font-size: 20px;" href="{{url('/shop/accessories/Rugs-Coasters')}}">Коврики</a></li>
                        <li><a style="font-size: 20px;" href="{{url('/shop/сonsumables')}}">Расходники</a></li>
                        <li><a style="font-size: 20px;" href="{{url('/shop/tweezers')}}">Щипчики</a></li>
                        <li class="mobile-menu-list-line"></li>
            ...
            <div class="header-bottom">
                <ul class="menu-categories">
                    <li class="menu-categories__item">
                        <a class="menu-categories__link" href="{{ url('/shop/everything-for-hairdressers/machines')}}">Машинки</a>
                    </li>
                    <li class="menu-categories__item">
                        <a class="menu-categories__link" href="{{ url('/shop/everything-for-hairdressers/Scissors')}}">Ножницы</a>
                    </li>
                    <li class="menu-categories__item">
                    ...
                    <li class="menu-categories__item">
                        <a class="menu-categories__link" href="{{url('/shop/everything-for-colorists/cups')}}">Чашки</a>
                    </li>
                    <li class="menu-categories__item">
                        <a class="menu-categories__link" href="{{url('/shop/accessories/Rugs-Coasters')}}">Коврики</a>
                    </li>
                    <li class="menu-categories__item">
                        <a class="menu-categories__link" href="{{url('/shop/сonsumables')}}">Расходники</a>
                    </li>
                    <li class="menu-categories__item">
                        <a class="menu-categories__link" href="{{url('/shop/tweezers')}}">Щипчики</a>
                    </li>
                </ul>
            </div>
        </div>
