        ...
        <div class="container">
            <div class="product-page__wrapper">
                <div class="product-page__image">
                    <img id="main-image" src="/product/{{ explode(',', $product->images)[0] }}"
                         alt="{{$product->name}}">
...
{{--                        </button>--}}
{{--                        <button class="favorite-button" id="favorite-button">--}}
{{--                            <img src="{{asset('../images/compare.svg')}}" alt="Добавить в избранное" id="favorite-icon">--}}
{{--                        </button>--}}
                        <form>
                            <div class="rating">
                    ...
                    <div class="product-page-character">
                        ...
                        <ul class="product-page-character__list">
                            ...
                            {{--                                <p class="product-page-price">{{ number_format($product->sale_price, 2, '.', ' ') }}<span>₸</span></p>--}}
